                ...
                <table border='0' width="100%" cellspacing='0' cellpadding='0'>
                    <tr>
                        ...
                        <td>
                            ...
                            if(EG_DEVEL && isset($eg_node))
                            echo "<a href='".$EG_DIR.'/'.pwe_get_module_option('m_admin', 'link')."/'>Администрирование</a><br/>";
    
                            if (pwe_get_module_option('g_sitemap', 'path'))
                            echo "<a href='".$EG_DIR.pwe_get_module_option('g_sitemap', 'path')."'>Карта сайта</a><br/>";
    
                            if (pwe_get_module_option('g_search', 'path'))
                            echo "<a href='".$EG_DIR.pwe_get_module_option('g_sitemap', 'path')."'>Поиск</a><br/>";
                            </b></small>
                            *}
                            {/block}
                        </td>
                        ...
                        <tr>
                            ...
                            {foreach $level1 as $item1}
                                {if $item1.$a.menu}
                                    {if $item1.selected}
                                        <!--item1h-->
                                        <td style="white-space: nowrap;" class='hl'><a href='{'../'|str_repeat:$upper_repeats}{$item1.$a.link}/'>{$item1.$a.title|default:$item1.$a.link}</a></td>
                                        <!--/item1h-->
                                    {else}
                                        <!--item1-->
                                        <td style="white-space: nowrap;"><a href='{'../'|str_repeat:$upper_repeats}{$item1.$a.link}/'>{$item1.$a.title|default:$item1.$a.link}</a></td>
                                        <!--/item1-->
                                    {/if}
                                {/if}
                            {/foreach}
